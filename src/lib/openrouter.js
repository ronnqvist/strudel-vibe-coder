...
export async function generateStrudelCode(apiKey, model, chatHistory, userMessage, modelName) {
    ...
    try {
        ...
        if (extractedCode) {
            const attribution = `// Generated by ${modelName || model} via https://ronnqvist.github.io/strudel-vibe-coder/`;
            extractedCode = `${attribution}\n${extractedCode}`;
        }
